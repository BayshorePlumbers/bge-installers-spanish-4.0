const HTECHEG_PRINT_PAYLOAD_KEY = 'htechEG_print_payload_v1';
const HTECHEG_PRINT_RETURN_KEY = 'htechEG_print_return_v1';
const HTECHEG_DEFAULT_RETURN_URL = 'htechEG.html';
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(HTECHEG_PRINT_RETURN_KEY) || HTECHEG_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(HTECHEG_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(HTECHEG_PRINT_RETURN_KEY);
  }
  ...
  function installReturnListeners() {
    ...
    function renderPayload() {
        const payload = sessionStorage.getItem(HTECHEG_PRINT_PAYLOAD_KEY);
        ...
        sheet.innerHTML = `<div id="printRoot">${payload}</div>`;
        return true;
    }
